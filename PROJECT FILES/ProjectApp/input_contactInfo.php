...
//try{
  ...
  $addContact = "INSERT INTO `ContactInfo`(`projectID`, `firstName`, `lastName`, `street`, `city`, `state`, `zip`, `email`, `dayPhone`) VALUES ('$last_id', '$_POST[first]', '$_POST[last]', '$_POST[cStreet]', '$_POST[cCity]', '$_POST[cState]', '$_POST[cZip]', '$_POST[cEmail]', '$_POST[cPhone]')";

  $addContact2 = "INSERT INTO `ContactInfo` (`projectID`, `firstName`, `lastName`, `street`, `city`, `state`, `zip`, `email`, `dayPhone`) VALUES ('19', 'Carly', 'Brock', '1500 N Warner', 'Tacoma', 'WA', '98416', 'carly@email.com', '2538791414')";

  echo "<br>$addContact<br/>$addContact2";
